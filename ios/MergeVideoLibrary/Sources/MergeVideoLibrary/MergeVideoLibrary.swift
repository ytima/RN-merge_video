...
@available(iOS 11.0, *)
@objc (MergeVideoLibrary)
public class MergeVideoLibrary: NSObject {
    ...
    func mergeVideo(_ firstVideoURL: URL?, audioURL: URL?) -> URL? {
        ...
        guard let firstTrack = firstTrack else { return nil }
